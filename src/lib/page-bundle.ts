...
export function summarizePageBundle(page: Page, pageLinks: Link[]) {
  return {
    ...
    links: pageLinks.map((link) => ({
      ...
      span: link.span,
      mobileSpan: link.mobileSpan,
      variant: link.variant,
      layout: link.layout || undefined,
      iconPlacement: link.iconPlacement || undefined,
      ...
      iconImageUrl: link.iconImageUrl || undefined,
      badge: link.badge || undefined,
      showArrow: link.showArrow,
      arrowStyle: link.arrowStyle || undefined,
      arrowPosition: link.arrowPosition || undefined,
      showDivider: link.showDivider,
      leadingIconUrl: link.leadingIconUrl || undefined,
      secondaryText: link.secondaryText || undefined,
