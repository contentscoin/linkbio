...
const FMGS_SCHEMA: PageSchema = {
  ...
  footer: {
    label: "FMGS 홈",
    url: "https://fmgs.co.kr",
    style: "fmgs",
  },
};

/** Pixel-oriented FMGS artboard (853×1844). Schema-first render only. */
const FMGS_EXACT_SCHEMA: PageSchema = {
  ...structuredClone(FMGS_SCHEMA),
  templateId: "fmgs-exact",
  canvas: { width: 853, height: 1844 },
  contentWidth: 765,
  brand: {
    displayName: "FMGS",
    showHandle: false,
    showAvatar: false,
    // Set via upload_asset → update_page_content({ logoUrl })
    logoUrl: undefined,
  },
  sections: [
    {
      ...
      heroGraphic: "golf",
      // Optional: upload_asset → heroGraphicUrl / heroImageUrl
    },
    {
      type: "cta",
      id: "cta",
...
export const SCHEMA_TEMPLATES: SchemaTemplateMeta[] = [
  ...
  baseTemplate({
    ...
    name: "FMGS Exact",
    description:
      "시안 853×1844 전용. schema-first 렌더·spotlight 파미골·전체폭 바로가기·FMGS footer.",
    category: "brand",
    thumbnail: "/designer/thumbs/fmgs-premium.svg",
    theme: "navy-lime",
    contentWidth: 765,
    schema: FMGS_EXACT_SCHEMA,
  }),
  baseTemplate({
    id: "corporate-grid",
    name: "Corporate Grid",
